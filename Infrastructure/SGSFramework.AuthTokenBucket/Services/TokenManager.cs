...
namespace SGSFramework.AuthTokenBucket.Services
{
    ...
    public sealed class TokenManager
    {
        ...
        /// </summary>
        public Task<string> GenerateAccessTokenAsync(IdentityUser<Guid> user, string bitmaskString, string deviceId)
        {
            ...
            var claims = new List<Claim>
    {
        ...
        //將超過 64 位的複合權限遮罩以字串型式注入 Claim 載體
        ...
        /// <summary>
        /// 從已過期或不安全的 Access Token 中安全提取 ClaimsPrincipal 身分
        /// </summary>
