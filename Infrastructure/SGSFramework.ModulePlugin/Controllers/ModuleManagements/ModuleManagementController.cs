...
{
    private readonly IModuleManagementApplicationService _moduleAppService = moduleAppService ?? throw new ArgumentNullException(nameof(moduleAppService));
    private readonly ILogger<ModuleManagementController> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
