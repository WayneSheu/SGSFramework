...
namespace SGSFramework.ModulePlugin.Controllers.Auths
{
    /// <summary>
    ...
    [ApiController]
    [Route("api/auth/sso")]
    [Menu("AD 單一登入", "fa-solid fa-user-shield", order: 10, parent: "Auth")]
    [RequiresPermission("AUTH_ADSSO_READ")]//定義模組層級預設權限 (若方法未定義則繼承此權限)  
    [Order(10)]//階層排序
    [Description("AD 單一登入整合器")] // 功能描述
    ...
    public abstract class AdSsoController<TUser> : ApiControllerBase where TUser : IdentityUser, new()
    {
        ...
        /// </summary>
        [HttpPost("microsoft")]
        [Menu("微軟 SSO 回調", "fa-solid fa-user-shield", order: 1, parent: "AD 單一登入")]
        [RequiresPermission("AUTH_ADSSO_MICROSOFT")]//定義方法層級權限 (若方法未定義則繼承模組層級權限)
        [Description("微軟 SSO 回調處理器")]
